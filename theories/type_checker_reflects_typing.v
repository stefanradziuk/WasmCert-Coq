...
Axiom type_update_select_agree_bet_ax_1:
  forall C l tm, {tn : seq value_type &
    (c_types_agree (CT_top_type l) tn) ** (be_typing C [:: BI_select] (Tf tn tm))}.

Axiom type_update_select_agree_bet_ax_2:
  forall C l tm,
  {tn : seq value_type &
